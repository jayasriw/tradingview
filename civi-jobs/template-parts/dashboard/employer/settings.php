...
<div class="dash-card" style="margin-bottom:24px">
    <div class="dash-card-header">
        <h3 class="dash-card-title">👤 <?php esc_html_e( 'Account Information', 'civijobs' ); ?></h3>
    </div>
        ...
        <form id="account-info-form">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label><?php esc_html_e( 'Display Name', 'civijobs' ); ?></label>
                    <input type="text" name="display_name" class="form-control" value="<?php echo esc_attr( $user->display_name ); ?>" required>
                </div>
                <div class="form-group">
                    <label><?php esc_html_e( 'Email Address', 'civijobs' ); ?></label>
                    ...
                    <p style="font-size:0.75rem;color:var(--color-gray-500);margin-top:4px"><?php esc_html_e( 'Contact support to change email.', 'civijobs' ); ?></p>
                </div>
            </div>
            <div id="account-info-messages"></div>
            <button type="submit" class="btn btn-primary"><?php esc_html_e( 'Save Changes', 'civijobs' ); ?></button>
        </form>
    </div>
</div>
...
<div class="dash-card" style="margin-bottom:24px">
    ...
    <div class="dash-card-body">
        <form id="email-prefs-form">
            ...
            <?php
            $prefs = [
                'notify_new_application'  => __( 'New job application received', 'civijobs' ),
                'notify_new_message'      => __( 'New messages', 'civijobs' ),
                'notify_meeting_update'   => __( 'Meeting updates', 'civijobs' ),
                'notify_job_approved'     => __( 'Job listing approved', 'civijobs' ),
                'notify_package_expiring' => __( 'Package expiry reminders', 'civijobs' ),
                'notify_newsletter'       => __( 'Newsletter and product updates', 'civijobs' ),
            ];
...
<div class="dash-card" style="border-color:var(--color-danger)">
    ...
    <div class="dash-card-body">
        <p style="color:var(--color-gray-600);margin-bottom:16px">
            <?php esc_html_e( 'Deleting your employer account will remove all your job listings and associated data permanently.', 'civijobs' ); ?>
        </p>
        <button class="btn btn-danger" id="delete-account-btn"
                data-confirm="<?php esc_attr_e( 'Are you sure you want to delete your account? All jobs and data will be permanently removed.', 'civijobs' ); ?>">
